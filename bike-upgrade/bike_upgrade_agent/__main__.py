...
from bike_upgrade_agent.agent_executor import BikeUpgradeAgentExecutor
...
skill = AgentSkill(
    id="bike-upgrade",
    name="Bike Part Upgrade",
    description=(
        "Helps cyclists choose the best component upgrades for their bike — "
        "recommends specific parts with compatibility checks, pricing, and installation guidance."
    ),
    tags=["bikes", "cycling", "upgrades", "components", "parts"],
    examples=[
        "I want to upgrade the brakes on my Trek Domane",
        "What groupset upgrade makes sense for my Shimano 105?",
        "My drivetrain is worn out, what should I replace it with?",
        "Best budget wheelset upgrade for a gravel bike under $500",
    ],
)

agent_card = AgentCard(
    name="Bike Upgrade Agent",
    description=(
        "A conversational AI agent that recommends the best component upgrades "
        "for your bike based on your current setup, goals, and budget."
    ),
    version="1.0.0",
...
request_handler = DefaultRequestHandler(
    agent_executor=BikeUpgradeAgentExecutor(),
