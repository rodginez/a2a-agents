...
Usage:
    uvicorn bike_upgrade_agent.a2a_server:app --host 0.0.0.0 --port 8080
"""
...
from bike_upgrade_agent.agent import SYSTEM_PROMPT
...
app = FastAPI(title="Bike Part Upgrade A2A Agent")
...
AGENT_CARD = {
    ...
    "description": (
        ...
        "upgrades for their bike based on their current setup, goals, and budget."
    ),
    "url": AGENT_URL,
    "version": "1.0.0",
    ...
    "skills": [
        {
            ...
            "name": "Bike Part Upgrade Recommendation",
            "description": (
                "Recommends specific bike component upgrades with compatibility checks, "
                "price estimates, and installation guidance based on the user's current "
                "setup, riding goals, and budget."
            ),
            "tags": ["bikes", "cycling", "components", "upgrades", "maintenance"],
            "examples": [
                "I want to upgrade my brakes on a 2019 Trek FX3",
                "What groupset upgrade should I get for my road bike?",
                "My shifting is sloppy — what should I replace?",
                "Best wheelset upgrade under $500 for a gravel bike",
                "I want to go from rim brakes to disc — is it possible?",
            ],
        }
    ],
}
