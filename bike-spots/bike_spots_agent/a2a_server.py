"""
A2A server for the Bike Spots Agent — v0.3.0 compliant.
...
Usage:
    uvicorn bike_spots_agent.a2a_server:app --host 0.0.0.0 --port 8080
"""
...
from bike_spots_agent.agent import SYSTEM_PROMPT
...
app = FastAPI(title="Bike Spots A2A Agent")
...
AGENT_CARD = {
    ...
    "description": (
        "A conversational AI agent that suggests the best public parks, trails, "
        "and cycling paths in any city based on the user's riding style and experience."
    ),
    "url": AGENT_URL,
    "version": "1.0.0",
    ...
    "skills": [
        {
            "id": "bike-spots",
            "name": "Bike Spot Finder",
            "description": (
                "Suggests public parks, greenways, trails, and cycling paths in a given city, "
                "tailored to the user's riding style, experience level, and preferences."
            ),
            "tags": ["bikes", "cycling", "parks", "trails", "routes", "city"],
            "examples": [
                "Where can I ride my bike in Austin, TX?",
                "Best parks for mountain biking in Denver",
                "I'm visiting Barcelona — where should I cycle?",
                "Family-friendly bike paths in Chicago",
                "Good gravel riding spots near Portland",
            ],
        }
    ],
}
